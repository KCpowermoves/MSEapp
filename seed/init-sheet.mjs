...
const TABS = [
  ...
  },
  {
    ...
    validations: [
      { col: "E", values: ["PTAC", "Standard", "Medium", "Large"] },
...
const PAY_RATES_DATA = [
  ...
  ["Install Pay", "Standard", 50, "3-20 tons"],
  ["Install Pay", "Medium", 75, "20-50 tons"],
  ["Install Pay", "Large", 100, "50+ tons"],
  ["Sales Bonus", "PTAC", 5, "100% to Sold By tech"],
  ["Sales Bonus", "Standard", 30, "100% to Sold By tech"],
  ["Sales Bonus", "Medium", 50, "100% to Sold By tech"],
  ["Sales Bonus", "Large", 75, "100% to Sold By tech"],
