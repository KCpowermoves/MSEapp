#!/usr/bin/env node
// Idempotent: creates the "Engineering Projects" tab on the production
// sheet if it doesn't already exist. Safe to re-run.
//
// Usage:
//   node scripts/init-engineering-tab.mjs           # dry run
//   node scripts/init-engineering-tab.mjs --apply   # commit changes
